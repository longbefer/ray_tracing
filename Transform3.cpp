...
void CTransform3::Identity()//µ¥Î»¾ØÕó
{
...
void CTransform3::Translate(double tx,double ty,double tz)//Æ½ÒÆ±ä»»¾ØÕó
{
	Identity();
	T[0][3]=tx; 
	T[1][3]=ty; 
...
void CTransform3::RotateX(double beta)//ÈÆXÖáĞı×ª±ä»»¾ØÕó
{
	Identity();
...
void CTransform3::RotateY(double beta)//ÈÆYÖáĞı×ª±ä»»¾ØÕó
{
	Identity();
	double rad=beta*PI/180;
...
void CTransform3::RotateZ(double beta)//ÈÆZÖáĞı×ª±ä»»¾ØÕó
{
	Identity();
	double rad=beta*PI/180;
...
void CTransform3::MultiplyMatrix()//¾ØÕóÏà³Ë
{
